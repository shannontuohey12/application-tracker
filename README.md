...
- **Add Applications** – Quickly log new applications with company name, role, status, and date applied.  
- **Edit Applications** – Update application details as your process evolves.  
- **Delete Applications** – Remove applications that are no longer relevant.  
- **Status Badges** – Visual indicators for Applied, Interview, Offer, and Rejected.  
